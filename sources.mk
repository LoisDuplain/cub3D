...
SRCS += sources/bettermlx/window/bettermlx_screenshot.c
...
SRCS += sources/game/init_mouse.c
SRCS += sources/game/key_press_hook.c
SRCS += sources/game/key_release_hook.c
SRCS += sources/game/level/change_level.c
SRCS += sources/game/level/init_current_level.c
SRCS += sources/game/level/next_level.c
...
SRCS += sources/game/loop/render_minimap.c
SRCS += sources/game/loop/update_loop.c
SRCS += sources/game/mouse_move_hook.c
SRCS += sources/game/plane/create_plane.c
SRCS += sources/game/plane/draw_plane_texture.c
SRCS += sources/game/plane/get_plane_intrsct_point.c
SRCS += sources/game/plane/get_planes.c
...
SRCS += sources/game/player/change_fov.c
SRCS += sources/game/player/change_render_distance.c
SRCS += sources/game/player/init_player.c
SRCS += sources/game/player/move_player.c
SRCS += sources/game/player/move_player_fb.c
SRCS += sources/game/player/move_player_lr.c
SRCS += sources/game/player/rotate_camera.c
SRCS += sources/game/player/rotate_camera_kb.c
SRCS += sources/game/player/sprite_collide_player.c
