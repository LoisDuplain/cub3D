...
SRCS += sources/game/plane/update/x/update_x_plane.c
...
SRCS += sources/loop/render/get_intrsct_point.c
SRCS += sources/loop/render/is_in_world.c
SRCS += sources/loop/render/x/get_x_neg_planes.c
SRCS += sources/loop/render/x/get_x_pos_planes.c
SRCS += sources/loop/render/x/intrsct_x_plane.c
SRCS += sources/loop/render/y/get_y_neg_planes.c
SRCS += sources/loop/render/y/get_y_pos_planes.c
SRCS += sources/loop/render/y/intrsct_y_plane.c
SRCS += sources/loop/render/z/get_z_neg_planes.c
SRCS += sources/loop/render/z/get_z_pos_planes.c
