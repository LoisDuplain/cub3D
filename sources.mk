...
SRCS += sources/level/parser/empty_texture/parse_color_empty_texture.c
SRCS += sources/level/parser/empty_texture/parse_empty_texture.c
SRCS += sources/level/parser/empty_texture/parse_splitted_color_in_empty_texture.c
SRCS += sources/level/parser/empty_texture/parse_xpm_empty_texture.c
SRCS += sources/level/parser/param/get_param_type.c
SRCS += sources/level/parser/param/parse_east_param.c
SRCS += sources/level/parser/param/parse_north_param.c
SRCS += sources/level/parser/param/parse_param.c
SRCS += sources/level/parser/param/parse_resolution_param.c
SRCS += sources/level/parser/param/parse_south_param.c
SRCS += sources/level/parser/param/parse_west_param.c
SRCS += sources/level/parser/parse_level.c
